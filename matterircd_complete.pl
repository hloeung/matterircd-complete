...
# current channel, e.g.:
#
#   Thread ID: https://URL/TEAM/pl/5nsmwg844irjppej...
#   Message ID: https://URL/TEAM/pl/79w7u...
#
# Configure the base URL for permalinks (default: Canonical's instance):
#
...
Irssi::settings_add_str('matterircd_complete', 'matterircd_complete_permalink_base_url', 'https://REPLACE.URL/REPLACE.TEAM/pl/');
